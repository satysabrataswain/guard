...
class Header(lief.Object):
    ...
    def has_characteristic(self, characteristic: CHARACTERISTICS) -> bool: ...

    def add_characteristic(self, characteristic: CHARACTERISTICS) -> None: ...

    def remove_characteristic(self, characteristic: CHARACTERISTICS) -> None: ...
...
class OptionalHeader(lief.Object):
    ...
    def __iadd__(self, arg: DLL_CHARACTERISTICS, /) -> OptionalHeader: ...

    def __isub__(self, arg: DLL_CHARACTERISTICS, /) -> OptionalHeader: ...

    def __contains__(self, arg: DLL_CHARACTERISTICS, /) -> bool: ...
...
class RelocationEntry(lief.Relocation):
    ...
    @overload
    def __init__(self, arg0: int, arg1: BASE_TYPES, /) -> None: ...
...
class CodeView(Debug):
    ...
    @overload
    def __init__(self, arg: SIGNATURES, /) -> None: ...
...
class PDBChecksum(Debug):
    def __init__(self, algo: HASH_ALGO, hash: Sequence[int]) -> None: ...
...
class ExDllCharacteristics(Debug):
    ...
    def has(self, characteristic: CHARACTERISTICS) -> bool: ...
...
class ResourcesManager(lief.Object):
    ...
    def get_node_type(self, type: TYPE) -> ResourceNode | None: ...
...
class ResourceVersion(lief.Object):
    class fixed_file_info_t:
        ...
        def has(self, flag: FILE_FLAGS) -> bool: ...
...
class ResourceDialog(lief.Object):
    ...
    @overload
    def has(self, arg: DIALOG_STYLES, /) -> bool: ...

    @overload
    def has(self, arg: WINDOW_STYLES, /) -> bool: ...

    @overload
    def has(self, arg: WINDOW_EXTENDED_STYLES, /) -> bool: ...
...
class ResourceAccelerator(lief.Object):
    ...
    def has(self, arg: FLAGS, /) -> bool: ...

    def add(self, arg: FLAGS, /) -> ResourceAccelerator: ...

    def remove(self, arg: FLAGS, /) -> ResourceAccelerator: ...
...
class x509(lief.Object):
    ...
    def verify(self, ca: x509) -> VERIFICATION_FLAGS: ...

    def is_trusted_by(self, ca_list: Sequence[x509]) -> VERIFICATION_FLAGS: ...
...
class FunctionOverride(DynamicFixup):
    ...
    @overload
    def find_bdd_info(self, arg: int, /) -> image_bdd_info_t | None: ...

    @overload
    def find_bdd_info(self, arg: FunctionOverrideInfo, /) -> image_bdd_info_t | None: ...
...
class LoadConfiguration(lief.Object):
    ...
    def has(self, arg: IMAGE_GUARD, /) -> bool: ...
...
class Builder:
    def __init__(self, binary: Binary, config: config_t) -> None: ...
