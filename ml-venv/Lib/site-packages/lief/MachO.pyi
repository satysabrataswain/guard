...
class Header(lief.Object):
    ...
    def __iadd__(self, arg: FLAGS, /) -> Header: ...

    def __isub__(self, arg: FLAGS, /) -> Header: ...
...
class Section(lief.Section):
    ...
    @overload
    @staticmethod
    def create(name: str, content: Sequence[int], type: TYPE = TYPE.REGULAR) -> Optional[Section]: ...

    @overload
    @staticmethod
    def create(name: str, type: TYPE = TYPE.REGULAR) -> Optional[Section]: ...
...
class ThreadLocalVariables(Section):
    ...
    def get(self, idx: int) -> Thunk | None: ...

    def set(self, idx: int, thunk: Thunk) -> None: ...

    def __getitem__(self, idx: int) -> Thunk | None: ...

    def __setitem__(self, idx: int, thunk: Thunk) -> None: ...
...
class FunctionVariantFixups(LoadCommand):
    ...
    def add(self, fixup: Fixup) -> FunctionVariantFixups: ...
...
class Stub:
    def __init__(self, target_info: target_info_t, address: int, raw_stub: Sequence[int]) -> None: ...
...
class Builder:
    ...
    @overload
    @staticmethod
    def write(binary: Binary, output: str, config: config_t) -> Union[lief.ok_t, lief.lief_errors]: ...
    ...
    @overload
    @staticmethod
    def write(fat_binary: FatBinary, output: str, config: config_t) -> Union[lief.ok_t, lief.lief_errors]: ...
