...
class EnumType(Type):
    ...
    def add_value(self, name: str, value: int) -> Optional[Value]: ...
...
class FunctionType(Type):
    ...
    def add_parameter(self, type: Type) -> Optional[Parameter]: ...
...
class StructType(Type):
    ...
    def add_member(self, name: str, type: Type, offset: int = -1) -> Optional[Member]: ...

    def add_bitfield(self, name: str, type: Type, bitsize: int, bitoffset: int = -1) -> Optional[Member]: ...
...
class Function:
    ...
    def set_ranges(self, ranges: Sequence[range_t]) -> Function: ...

    def set_external(self) -> Function: ...

    def set_return_type(self, type: Type) -> Function: ...

    def add_parameter(self, name: str, type: Type) -> Optional[Parameter]: ...

    def create_stack_variable(self, name: str) -> Optional[Variable]: ...

    def add_lexical_block(self, start: int, end: int) -> Optional[LexicalBlock]: ...

    def add_label(self, addr: int, label: str) -> Optional[Label]: ...
